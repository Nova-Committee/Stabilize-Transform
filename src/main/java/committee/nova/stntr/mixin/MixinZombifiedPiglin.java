...
public abstract class MixinZombifiedPiglin extends Zombie implements IEntityTransformable {
    private boolean converting;
    private int conversionTick;

    public MixinZombifiedPiglin(EntityType<? extends Zombie> e, Level w) {
        super(e, w);
    }

    @Override
    public boolean canConvert(Player player, ItemStack stack) {
        return StabilizeAndTransform.canTransformZPiglin(stack);
    }
